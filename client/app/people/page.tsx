          ...
          <div className='flex justify-between items-center  px-6'>
            <div className='flex space-x-4'>
              <div className='relative w-full '>
                          <div onClick={()=>handleToggle('account')} className={`flex flex-row w-36 justify-between items-center px-2 py-1 border border-gray-600 rounded-md ${toggle.account ? 'rounded-bl-none rounded-br-none': 'rounded-md'}`}>
              ...
              <div className='relative w-full '>
                          <div onClick={()=>handleToggle('org')} className={`flex flex-row w-36 justify-between items-center px-2 py-1 border border-gray-600 rounded-md ${toggle.org ? 'rounded-bl-none rounded-br-none': 'rounded-md'}`}>
            ...
            <div className='relative w-full '>
                          <div onClick={()=>handleToggle('recommend')} className={` flex flex-row w-36 justify-between items-center px-2 py-1 border border-gray-600 rounded-md ${toggle.recommend ? 'rounded-bl-none rounded-br-none': 'rounded-md'}`}>
